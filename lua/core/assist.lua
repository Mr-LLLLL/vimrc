...
local function load_autopairs()
    ...
    g.AutoPairsShortcutFastWrap = '<M-p>'
    ...
    require("diffview").setup({
        ...
        keymaps = {
            ...
            view = {
                ...
                { "n", "<leader>2", actions.conflict_choose("ours"), { desc = "Choose the OURS version of a conflict" } },
                { "n", "<leader>3", actions.conflict_choose("theirs"),
                    { desc = "Choose the THEIRS version of a conflict" } },
                { "n", "<leader>b", actions.conflict_choose("base"), { desc = "Choose the BASE version of a conflict" } },
                { "n", "<leader>a", actions.conflict_choose("all"),  { desc = "Choose all the versions of a conflict" } },
...
local function load_todo_comment()
